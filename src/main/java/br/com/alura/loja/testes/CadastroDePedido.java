...
public class CadastroDePedido {
    ...
    public static void main(String[] args) {
        ...
        Produto celular = produtoDao.buscarPorNome("Xiaomi Redmi").get(0);
        Produto videogame = produtoDao.buscarPorNome("PS5").get(0);
        Produto macbook = produtoDao.buscarPorNome("Macbook").get(0);
        ...
        List<RelatorioDDeVendasVo> relatorio = pedidoDao.relatorioDeVendas();
